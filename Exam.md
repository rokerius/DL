...
2. Нейронная сеть как композиция функций. Линейный слой, bias, функции активации, глубина, нелинейность, softmax. [01-04_06_08-Neural_Networks](01-04_06_08-Neural_Networks.md)
3. Обучение нейронной сети. Функция потерь, эмпирический риск, mini-batch training, train/validation/test split. [01-04_06_08-Neural_Networks](01-04_06_08-Neural_Networks.md)
4. Backpropagation и автоматическое дифференцирование. Вычислительный граф, правило цепочки, forward-mode и reverse-mode autodiff. [01-04_06_08-Neural_Networks](01-04_06_08-Neural_Networks.md)
5. Оптимизация в DL. Gradient descent, SGD, Momentum, Nesterov, RMSProp, Adam/AdamW, роль learning rate. [Optimizers](DL/optimizers)
6. Стабилизация и регуляризация обучения. Инициализация, нормализация, dropout, weight decay, early stopping, data augmentation. [01-04_06_08-Neural_Networks](01-04_06_08-Neural_Networks.md)
7. Практический PyTorch-пайплайн. Tensor, autograd, nn.Module, Dataset, DataLoader, train/eval. [PyTorch](DL/PyTorch.md)
8. Диагностика обучения нейросети. Переобучение, tiny-overfit test, анализ train/validation curves, leakage, подбор гиперпараметров. [01-04_06_08-Neural_Networks](01-04_06_08-Neural_Networks.md)
9. Изображение как тензор и мотивация CNN. Почему полносвязная сеть плохо использует структуру изображения. [09-14-CNN](09-14-CNN.md)
10. Операция свертки. Локальность, разделение весов, padding, stride, receptive field, dilation. [09-14-CNN](09-14-CNN.md)
11. Базовая CNN для классификации изображений. Feature maps, conv, pooling, classifier head. [09-14-CNN](09-14-CNN.md)
12. Виды сверток и эффективные операции. 1x1 convolution, separable/depthwise convolution, transposed convolution. [09-14-CNN](09-14-CNN.md)
13. Классические CNN-архитектуры. LeNet, AlexNet, VGG, Inception: как развивались идеи глубины, сверток и feature extraction. [09-14-CNN](09-14-CNN.md)
14. ResNet и современные CNN-backbone. Skip connections, residual block, bottleneck, идеи эффективных архитектур. [09-14-CNN](09-14-CNN.md)
15. Transfer learning в компьютерном зрении. Feature extraction, fine-tuning, заморозка слоев, использование предобученных backbone. [15-Transfer_Learning](15-Transfer_Learning.md)
16. Семантическая сегментация. Постановка задачи, отличие от классификации, FCN, encoder-decoder подход, superpixels. [16-19-Semantic_Segmentation](16-19-Semantic_Segmentation.md)
17. U-Net и современные подходы к сегментации. Skip connections, upsampling, multiscale features, transformer/promptable segmentation как расширения. [16-19-Semantic_Segmentation](16-19-Semantic_Segmentation.md)
18. Instance, panoptic segmentation и human pose estimation. Чем эти задачи отличаются от semantic segmentation, какие идеи используются. [16-19-Semantic_Segmentation](16-19-Semantic_Segmentation.md)
19. Метрики и функции потерь в сегментации. Pixel-wise cross-entropy, IoU/mIoU, Dice/F1, особенности оценки качества. [16-19-Semantic_Segmentation](16-19-Semantic_Segmentation.md)
20. Object detection. Постановка задачи, bounding boxes, confidence, IoU, отличие detection от classification и segmentation. [20-23-Object_Detection](20-23-Object_Detection.md)
21. Метрики и post-processing в детекции. Precision/recall, AP/mAP, Non-Maximum Suppression. [20-23-Object_Detection](20-23-Object_Detection.md)
22. Two-stage object detection. Sliding window, R-CNN, Fast R-CNN, Faster R-CNN, Region Proposal Network. [20-23-Object_Detection](20-23-Object_Detection.md)
23. One-stage object detection. YOLO, SSD, RetinaNet, anchors, anchor-free идеи, trade-off скорости и качества. [20-23-Object_Detection](20-23-Object_Detection.md)
24. Knowledge distillation. Teacher-student схема, soft labels, temperature, KL-divergence, зачем нужна дистилляция. [24-25-Knowledge_Distillation](24-25-Knowledge_Distillation.md)
25. Варианты и применения дистилляции. Дистилляция логитов, признаков и attention, чonline/offline/self-distillation, dataset distillation. [24-25-Knowledge_Distillation](24-25-Knowledge_Distillation.md)
26. Векторные представления слов. One-hot, distributional hypothesis, count-based embeddings, co-occurrence matrix, PMI/PPMI, LSA. [26-27-word2vec](26-27-word2vec.md)
27. Word2Vec и GloVe. Skip-gram, CBOW, negative sampling, интерпретация embedding space, аналогии и косинусная близость. [26-27-word2vec](26-27-word2vec.md)
28. Рекуррентные нейронные сети. Последовательные данные, hidden state, parameter sharing, BPTT, many-to-one/many-to-many задачи. [28-30-RNN](28-30-RNN.md)
29. Проблемы RNN и gated-архитектуры. Vanishing/exploding gradients, LSTM, GRU, teacher forcing, scheduled sampling. [28-30-RNN](28-30-RNN.md)
30. Seq2seq и attention до трансформеров. Encoder-decoder, bottleneck одного вектора, attention для машинного перевода. [28-30-RNN](28-30-RNN.md)
31. Токенизация текста. Word-level, char-level, subword, BPE, WordPiece, byte-level BPE, Unicode/UTF-8. [31-Tokenization](31-Tokenization.md)
32. Механизм внимания. Query, Key, Value, scaled dot-product attention, multi-head attention. [32-33-Transformer](32-33-Transformer.md)
33. Архитектура Transformer. Self-attention, masked attention, cross-attention, FFN, residual connections, LayerNorm, positional encoding. [32-33-Transformer](32-33-Transformer.md)
34. Pretraining в NLP. Зачем нужен self-supervised pretraining, encoder-only, encoder-decoder и decoder-only подходы. [Pretraining в NLP](34-36-Pretraining_NLP.md)
35. BERT-подобные и T5-подобные модели. Masked language modeling, text-to-text постановка, fine-tuning под downstream tasks. [Pretraining в NLP](34-36-Pretraining_NLP.md)
36. GPT-подобные модели. Autoregressive generation, next-token prediction, decoder-only архитектура, in-context learning. [Pretraining в NLP](34-36-Pretraining_NLP.md)
